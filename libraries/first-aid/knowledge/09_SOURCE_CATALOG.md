...
## 1. Adult Choking 2025 Update – First Aid Techniques Explained

- **Video ID:** `FbvdPMM1KW8`
- **URL:** https://www.youtube.com/watch?v=FbvdPMM1KW8
- **Upload date:** 2026-02-15
- **Duration:** 05:38
- **Source file:** `sources/clean/FbvdPMM1KW8.txt`
- **Main subjects:** distinguishing a mild (partial) from a severe (complete) airway obstruction in a choking adult, and the back-slap/abdominal-thrust sequence used to treat the severe case
- **Emergencies:** an adult with a partial airway obstruction, still coughing and able to make noise, an adult with a complete airway obstruction, unable to make noise or breathe, a life-threatening condition
- **Procedures:** for a mild/partial obstruction — encourage coughing and stay calm; noise-making is treated as a sign the airway is not fully blocked, for a severe/complete obstruction — ask permission to help, call emergency medical services, then alternate up to five back slaps (heel of the hand, between the shoulder blades, with the rescuer's other arm supporting the casualty's chest) with up to five abdominal thrusts (thumb knuckle placed under the ribcage/above the abdominals, thrusting to expel air upward), repeating until the blockage clears or the casualty becomes unconscious, if the casualty becomes unconscious, check the airway, ensure the ambulance has been called, and begin CPR, after a successful clear, keep the casualty calm, seated, with fresh air and loosened clothing, and always have them seek medical attention afterward
- **Important concepts:** adult and child choking treatment stated to be identical in technique, adapted only in positioning, noise-making treated as the practical marker distinguishing a partial from a complete obstruction, since "all the time they're making a noise they are breathing"

## 2. Adult CPR & AED Pad Placement – 2025 Update (What’s Changed?

- **Video ID:** `rkYJQycMoPM`
- **URL:** https://www.youtube.com/watch?v=rkYJQycMoPM
- **Upload date:** 2026-02-15
- **Duration:** 02:59
- **Source file:** `sources/clean/rkYJQycMoPM.txt`
- **Main subjects:** the adult CPR-plus-AED sequence when helpers are available, and precise adult AED pad placement
- **Emergencies:** an unresponsive, non-breathing adult with helpers present and a defibrillator obtainable
- **Procedures:** check the scene for danger, check for a response, shout for help, send a helper to call emergency services and find a defibrillator, if alone with no phone or helpers, open the airway and check breathing for 10 seconds; if not breathing, leave to call emergency services yourself, only detouring for a defibrillator if it can be reached within about a minute, with helpers available, continue CPR (30 chest compressions to 2 rescue breaths, non-stop) while a helper retrieves the AED, put the AED on as soon as it arrives, without delay, and follow its voice prompts; do not touch the patient while it analyzes; after a shock is delivered, it is safe to touch the patient again and CPR resumes (30:2) until the machine reanalyzes (roughly every two minutes), adult AED pad placement: one pad under the right clavicle, the other under the left armpit, spaced a hand's width apart, on dried, naked skin (shaving hair at the site if needed for the pad to stick)
- **Important concepts:** the 30-compressions-to-2-breaths ratio for adult CPR, distinct from the child ratio (15:2) covered elsewhere in this collection, reassurance that an AED cannot cause harm by being applied: "the AED will only deliver a shock if it's needed... you can't hurt anybody by placing an AED on them"

## 3. Anaphylaxis Explained: Signs, Symptoms & EpiPen Use

- **Video ID:** `SGIfqYsi8IQ`
- **URL:** https://www.youtube.com/watch?v=SGIfqYsi8IQ
- **Upload date:** 2025-07-28
- **Duration:** 05:02
- **Source file:** `sources/clean/SGIfqYsi8IQ.txt`
- **Main subjects:** the difference between a general allergic reaction and anaphylaxis, and detailed step-by-step use of an adrenaline auto-injector pen (EpiPen and Jext)
- **Emergencies:** a general allergic reaction (sneezing, wheezing, coughing, skin rash), anaphylaxis — a severe, life-threatening allergic reaction affecting the respiratory system
- **Procedures:** call emergency medical services immediately if anaphylaxis is suspected, then retrieve the person's auto-injector pen, have them sit in a comfortable position (a "W" position is suggested, but comfort takes priority), remove the cap (from the opposite end to where the needle emerges), press the injector firmly against the outer thigh through clothing (no need to undress the area) until it clicks, hold in place, then gently massage the site, a second dose can be given after 5 minutes if the person is still struggling to breathe — stated reasons a second pen may be needed: a missed injection, an accidental self-injection by the helper, or the pen's dose simply not being enough while waiting for the ambulance, a person with a known severe allergy should always carry two auto-injector pens; check they have both, and know where they are, if responsible for someone with this condition
- **Important concepts:** an allergen defined as any substance triggering an allergic reaction, with named common examples: pollen, house dust mites, mold, pets, nuts, fruits, latex, dairy, the specific hold-time discrepancy between EpiPen (3 seconds) and Jext (10 seconds) auto injectors — the source's stated workaround is to just hold every pen for 10 seconds regardless, to remove the need to remember which

## 4. Animal Bites and Insects

- **Video ID:** `pu0feSX4qh8`
- **URL:** https://www.youtube.com/watch?v=pu0feSX4qh8
- **Upload date:** 2025-07-24
- **Duration:** 06:56
- **Source file:** `sources/clean/pu0feSX4qh8.txt`
- **Main subjects:** animal bites (dogs/cats), hairy caterpillar (oak processionary moth) toxin exposure, and safe tick removal with Lyme disease awareness
- **Emergencies:** an animal bite (dog or cat) causing bleeding, tears, bruising, or broken bones, hairy caterpillar (oak processionary moth) hair exposure — itchy rash, and rarely eye/throat irritation or breathing problems, a tick bite, with the risk of Lyme disease
...
- **Upload date:** 2022-09-01
- **Duration:** 04:44
- **Source file:** `sources/clean/tFwJUPSU6Fw.txt`
- **Main subjects:** hazards from UK coastal sea life — sharp shells/barnacles, crabs, jellyfish stings, and weever fish stings — with a specific myth correction about jellyfish sting treatment
- **Emergencies:** a jellyfish sting, ranging from a painful mark to (rarely) a severe, life-threatening reaction, a weever fish sting, from standing on one buried in sand
...
- **Duration:** 01:08
- **Source file:** `sources/clean/AmXN6YjxtII.txt`
- **Main subjects:** a step-by-step response when a child has collapsed and is not responding, from checking breathing through AED shock delivery
- **Emergencies:** a child who has collapsed and is not responding or breathing normally
...
- **Duration:** 00:47
- **Source file:** `sources/clean/dLz7tn-bR9w.txt`
- **Main subjects:** a 2025 guideline change stating CPR should be started on a bed rather than delaying to move the person to the floor first
- **Emergencies:** someone found collapsed in a bed, not breathing normally
...
- **Duration:** 04:52
- **Source file:** `sources/clean/mlWdZtWAIVU.txt`
- **Main subjects:** diabetes as a condition (types 1 and 2), and the first-aid distinction and treatment between a hyperglycemic and a hypoglycemic emergency
- **Emergencies:** a hyperglycemic episode — high blood sugar, slower onset, a hypoglycemic episode ("a hypo") — low blood sugar, fast onset, more urgent to treat
...
- **Duration:** 04:35
- **Source file:** `sources/clean/ezLmv6ksiAA.txt`
- **Main subjects:** how electrical injury happens and why it can be dangerous to a rescuer, and the scene-safety first, treat-second approach to electrocution
- **Emergencies:** electrocution from mains electricity, high-voltage cables, or other electrical sources
...
- **Duration:** 01:00
- **Source file:** `sources/clean/daEErJU36-4.txt`
- **Main subjects:** the distinction between a heart attack (circulation problem) and cardiac arrest (electrical problem), and the different response each calls for
- **Emergencies:** heart attack — a blocked artery stopping blood reaching the heart muscle, person usually conscious, breathing, and talking, cardiac arrest — the heart stops pumping altogether, person is unresponsive and not breathing normally
...
- **Duration:** 04:49
- **Source file:** `sources/clean/Mzf-sslc2Zo.txt`
- **Main subjects:** the body's temperature-regulation "thermostat," and what happens when it fails at either temperature extreme, with a focus on heat exhaustion and heat stroke
- **Emergencies:** heat exhaustion (body temperature at or above 38°C, hot, sweaty, distressed), heat stroke (body temperature around 40°C, thermostat failure, a medical emergency), febrile convulsion in a child, caused by a rapid body-temperature rise
...
- **Upload date:** 2022-02-17
- **Duration:** 04:03
- **Source file:** `sources/clean/DVjMfc8dHf4.txt`
- **Main subjects:** the infant-specific (0-1) choking response, adapted from the adult/child version for airway positioning and thrust placement
- **Emergencies:** an infant (0-1) choking, silent and gasping
...
- **Duration:** 10:27
- **Source file:** `sources/clean/ohKowP1Posc.txt`
- **Main subjects:** concussion myths, how to recognize concussion via visible signs and reported symptoms, and the graduated rest-then-return-to-sport timeline recommended by UK sporting governing bodies
- **Emergencies:** suspected concussion following a direct or transmitted-force blow to the head or body
...
- **Duration:** 06:25
- **Source file:** `sources/clean/ba5_cInKwr0.txt`
- **Main subjects:** what a seizure is, the tonic-clonic pattern as a typical (not universal) example, and the first-aid response of protecting rather than restraining the person
- **Emergencies:** a convulsive (tonic-clonic) seizure, a non-convulsive seizure (described as "daydreaming"/absence-type)
...
- **Upload date:** 2023-07-13
- **Duration:** 06:22
- **Source file:** `sources/clean/gL2iE0wYm8w.txt`
- **Main subjects:** the four types of fracture named by the source, the core immobilize-don't-move treatment principle, and two sling techniques demonstrated for arm injuries
- **Emergencies:** a closed fracture (bone broken but not through the skin), an open fracture (bone broken and piercing the skin), a complicated fracture (a break causing a secondary complication, e.g. a punctured lung or trapped nerve), a greenstick/hairline fracture (common in children, whose bones are more flexible)
...
- **Duration:** 01:06
- **Source file:** `sources/clean/-q_O1aLYXlw.txt`
- **Main subjects:** correcting the common instinct to tilt the head back during a nosebleed, and the stated correct technique instead
- **Emergencies:** a nosebleed
...
- **Duration:** 04:31
- **Source file:** `sources/clean/cdNHeYQ2Knc.txt`
- **Main subjects:** the general clean-pressure-dressing approach to treating a bleeding wound, with specific adaptations demonstrated for a palm wound and a head wound
- **Emergencies:** a bleeding wound on a limb, palm, or head, with the risk of hypovolemic shock if bleeding isn't controlled
...
- **Duration:** 09:06
- **Source file:** `sources/clean/nrUJU3EhENY.txt`
- **Main subjects:** a general burn-treatment rule (cool for 20 minutes, protect with cling film) that applies regardless of cause, plus the SCALD framework for judging burn severity
- **Emergencies:** a burn or scald from any cause — fire, hot surfaces (including hot sand), sun, chemicals, or electricity
...
- **Duration:** 06:08
- **Source file:** `sources/clean/WBNLB4SUqZk.txt`
- **Main subjects:** what happens physically during an asthma attack, the two-inhaler system asthma sufferers carry, and step-by-step technique for using a reliever inhaler with and without a spacer (mouthpiece version) on an adult
- **Emergencies:** an asthma attack — airway muscles tighten, the lining swells, and mucus buildup narrows the airway further, making it hard to breathe out
...
- **Upload date:** 2022-11-17
- **Duration:** 03:32
- **Source file:** `sources/clean/_doDuU-FzTY.txt`
- **Main subjects:** hypothermia treatment (with the specific warning against rapid rewarming), prevention, and the two related cold-injury conditions frost nip and frostbite
- **Emergencies:** hypothermia — from cold air exposure or cold-water immersion, frost nip — skin freezing, red and white, painful but self-treatable, frostbite — deeper tissue/muscle/blood-vessel freezing, more serious
...
- **Duration:** 06:56
- **Source file:** `sources/clean/5Ar9386jn_E.txt`
- **Main subjects:** distinguishing a bee sting from a wasp sting (and why it changes treatment), general insect bite/sting symptoms, and recognizing when a bite/sting has become infected or anaphylactic
- **Emergencies:** a bee or wasp sting, a general insect bite (midges, gnats, mosquitoes, fleas, flies, mites, bed bugs), an infected bite/sting, anaphylaxis triggered by a sting
...
- **Duration:** 08:20
- **Source file:** `sources/clean/w5eqBMoTGcE.txt`
- **Main subjects:** poisoning by swallowed chemicals/drugs, food poisoning, and plant/fungi poisoning, with a shared core response of identifying the substance and calling emergency services
- **Emergencies:** swallowed poison (household chemicals, drugs — legal or illegal), food poisoning (bacterial or viral contamination, e.g. salmonella or E. coli), plant or fungi poisoning (e.g. foxglove, poisonous berries, death cap mushroom)
...
- **Duration:** 00:56
- **Source file:** `sources/clean/MH5zM1q0RlU.txt`
- **Main subjects:** why a bystander should not go into the water after a struggling swimmer, and what to do instead
- **Emergencies:** someone struggling or drowning in open water
...
- **Duration:** 10:19
- **Source file:** `sources/clean/bpA6uWkeuPA.txt`
- **Main subjects:** the same primary-survey/secondary-survey/recovery-position sequence as for an adult, applied first to a child (1-18) and then specifically adapted for an infant (0-1)
- **Emergencies:** an unconscious child or infant, breathing normally, with no obvious injury found on the secondary survey
...
- **Duration:** 06:27
- **Source file:** `sources/clean/JetIdXD7174.txt`
- **Main subjects:** the four medical types of shock (named for completeness), with hypovolemic shock (blood/fluid loss) covered in treatment depth
- **Emergencies:** hypovolemic shock — insufficient circulating blood or fluid, most commonly from hemorrhage or severe vomiting/diarrhea
...
- **Duration:** 10:22
- **Source file:** `sources/clean/NMQo-0kbX84.txt`
- **Main subjects:** general snake-bite first aid (identify, immobilize, get to hospital) versus the special pressure-immobilization technique reserved only for known neurotoxic/elapid snake bites, common snake-bite myths and why the source says each one makes things worse
- **Emergencies:** a general snake bite (any species, UK-focused examples given), a bite from a known neurotoxic/elapid snake (non-spitting cobras, mambas, coral snakes, sea snakes, and "actually everything in Australia")
...
- **Duration:** 04:32
- **Source file:** `sources/clean/U-NimqP2Ev4.txt`
- **Main subjects:** distinguishing a sprain from a strain as soft-tissue injuries, and the shared RICE treatment for both
- **Emergencies:** a sprain — an overstretched ligament (bone-to-bone) at a joint, a strain — a torn or overstretched muscle or tendon (muscle-to-bone)
...
- **Duration:** 07:15
- **Source file:** `sources/clean/UuQFAQAaOQo.txt`
- **Main subjects:** what a stroke is (including the two main mechanisms and a TIA/"mini stroke"), the FAST mnemonic for recognizing one, and the first-aid response while waiting for emergency services
- **Emergencies:** a stroke — a sudden interruption of blood supply to part of the brain, a TIA ("mini stroke") — a temporary blockage producing stroke-like symptoms that resolve
...
- **Duration:** 00:40
- **Source file:** `sources/clean/nmOqZM-xJzA.txt`
- **Main subjects:** the single most important first-aid skill, argued to be recognizing a serious problem and calling emergency services early, rather than any hands-on technique
...
- **Upload date:** 2026-02-15
- **Duration:** 07:07
- **Source file:** `sources/clean/ccDPTLFu9Po.txt`
- **Main subjects:** a full practical walkthrough combining the primary survey, secondary survey, and recovery position into one sequence for an unconscious adult assumed to have no catastrophic bleed
- **Emergencies:** an unconscious adult found on the floor, breathing normally, with no obvious catastrophic bleed
...
- **Duration:** 04:40
- **Source file:** `sources/clean/5bzqZ7ajeCQ.txt`
- **Main subjects:** what a spinal injury is, how one can happen, and the core "do not move them, support the head" first-aid rule, including the narrow exceptions where moving is necessary
- **Emergencies:** a suspected spinal injury (from a low-level fall, a road accident, a fall from height, or compression such as someone jumping on the back)
...
- **Upload date:** 2021-08-29
- **Duration:** 04:42
- **Source file:** `sources/clean/bV1WWhv-_Ag.txt`
- **Main subjects:** the same airway-narrowing mechanism behind an asthma attack as covered in this channel's other asthma video, demonstrated here with a child using a face-mask spacer
- **Emergencies:** an asthma attack in a child
...
- **Duration:** 07:36
- **Source file:** `sources/clean/2B9qqSP8nnc.txt`
- **Main subjects:** what should and should not go in a UK workplace first aid kit, framed around the HSE's first-aid-needs-assessment approach and the BS 8599 standard, demonstrated by repacking a real leisure-center kit
- **Emergencies:** none recorded
- **Procedures:** build kit contents from a first-aid-needs assessment rather than a fixed list; check against the BS 8599 standard as a reference, not a legal requirement, check expiry dates regularly, since an expired item's sterility can no longer be guaranteed by its manufacturer, demonstrated kit contents — disposable ice packs, sterile dressings in small/medium/large, scissors, micropore tape, triangular bandages, hypoallergenic plasters, cleaning wipes, latex-free gloves, face shields, foil blankets, and general PPE (aprons, goggles), suggested additions not in this particular kit — safety pins, sterile water/saline, tweezers, a first-aid guidance leaflet, a pocket mask, and compression bandages
- **Important concepts:** "potions, lotions, and sprays" as the source's rule for what must NOT go in a first aid kit — painkillers, creams, and sprays that a first aider is not qualified to administer

---

## Index by emergencies

**a bee or wasp sting** — Insect Bites and Stings |  Adult First Aid  | EMT First Aid Training | (`5Ar9386jn_E`)
...
**a child who has collapsed and is not responding or breathing normally** — Child Collapses & Not Breathing — What To Do (CPR + AED) (`AmXN6YjxtII`)

**a closed fracture (bone broken but not through the skin)** — How to help with a fracture |  Adult First Aid  | EMT First Aid Training (`gL2iE0wYm8w`)

**a complicated fracture (a break causing a secondary complication, e.g. a punctured lung or trapped nerve)** — How to help with a fracture |  Adult First Aid  | EMT First Aid Training (`gL2iE0wYm8w`)

**a convulsive (tonic-clonic) seizure** — How to help someone having a seizure |  Adult First Aid  | EMT First Aid Training | (`ba5_cInKwr0`)

**a general allergic reaction (sneezing, wheezing, coughing, skin rash)** — Anaphylaxis Explained: Signs, Symptoms & EpiPen Use (`SGIfqYsi8IQ`)

**a general insect bite (midges, gnats, mosquitoes, fleas, flies, mites, bed bugs)** — Insect Bites and Stings |  Adult First Aid  | EMT First Aid Training | (`5Ar9386jn_E`)

**a general snake bite (any species, uk-focused examples given)** — Snake Bites |  Health and Safety   | EMT First Aid Training | (`NMQo-0kbX84`)

**a greenstick/hairline fracture (common in children, whose bones are more flexible)** — How to help with a fracture |  Adult First Aid  | EMT First Aid Training (`gL2iE0wYm8w`)

**a hyperglycemic episode — high blood sugar, slower onset** — Diabetes |  Adult First Aid  | EMT First Aid Training | (`mlWdZtWAIVU`)

**a hypoglycemic episode ("a hypo") — low blood sugar, fast onset, more urgent to treat** — Diabetes |  Adult First Aid  | EMT First Aid Training | (`mlWdZtWAIVU`)

**a jellyfish sting, ranging from a painful mark to (rarely) a severe, life-threatening reaction** — Bites and stings from the sea|  Adult First Aid  | EMT First Aid Training | (`tFwJUPSU6Fw`)
...
**a strain — a torn or overstretched muscle or tendon (muscle-to-bone)** — Sprains and Strains |  Adult First Aid  | EMT First Aid Training (`U-NimqP2Ev4`)

**a stroke — a sudden interruption of blood supply to part of the brain** — Stroke |  Adult First Aid  | EMT First Aid Training | (`UuQFAQAaOQo`)

**a suspected spinal injury (from a low-level fall, a road accident, a fall from height, or compression such as someone jumping on the back)** — What is a SPINAL injury, How do you get a SPINAL injury and HOW to treat a SPINAL injury. (`5bzqZ7ajeCQ`)

**a tia ("mini stroke") — a temporary blockage producing stroke-like symptoms that resolve** — Stroke |  Adult First Aid  | EMT First Aid Training | (`UuQFAQAaOQo`)

**a tick bite, with the risk of lyme disease** — Animal Bites and Insects (`pu0feSX4qh8`)

**a weever fish sting, from standing on one buried in sand** — Bites and stings from the sea|  Adult First Aid  | EMT First Aid Training | (`tFwJUPSU6Fw`)

**an adult with a complete airway obstruction, unable to make noise or breathe, a life-threatening condition** — Adult Choking 2025 Update – First Aid Techniques Explained (`FbvdPMM1KW8`)

**an adult with a partial airway obstruction, still coughing and able to make noise** — Adult Choking 2025 Update – First Aid Techniques Explained (`FbvdPMM1KW8`)

**an animal bite (dog or cat) causing bleeding, tears, bruising, or broken bones** — Animal Bites and Insects (`pu0feSX4qh8`)

**an asthma attack in a child** — What is ASTHMA and how to treat it as a FIRST AIDER (`bV1WWhv-_Ag`)

**an asthma attack — airway muscles tighten, the lining swells, and mucus buildup narrows the airway further, making it hard to breathe out** — How to treat someone having an Asthma attack |  Adult First Aid  | EMT First Aid Training (`WBNLB4SUqZk`)

**an infant (0-1) choking, silent and gasping** — How to help a baby choking |  Child and Baby First Aid  | EMT First Aid Training | (`DVjMfc8dHf4`)

**an infected bite/sting** — Insect Bites and Stings |  Adult First Aid  | EMT First Aid Training | (`5Ar9386jn_E`)

**an open fracture (bone broken and piercing the skin)** — How to help with a fracture |  Adult First Aid  | EMT First Aid Training (`gL2iE0wYm8w`)
...
**anaphylaxis triggered by a sting** — Insect Bites and Stings |  Adult First Aid  | EMT First Aid Training | (`5Ar9386jn_E`)
...
**febrile convulsion in a child, caused by a rapid body-temperature rise** — Heat Exhaustion and Heat Stroke|  Adult First Aid  | EMT First Aid Training | (`Mzf-sslc2Zo`)

**food poisoning (bacterial or viral contamination, e.g. salmonella or e. coli)** — Poisoning |  Adult First Aid  | EMT First Aid Training | (`w5eqBMoTGcE`)

**frost nip — skin freezing, red and white, painful but self-treatable** — Hypothermia |  Adult First Aid  | EMT First Aid Training (`_doDuU-FzTY`)

**frostbite — deeper tissue/muscle/blood-vessel freezing, more serious** — Hypothermia |  Adult First Aid  | EMT First Aid Training (`_doDuU-FzTY`)

**hairy caterpillar (oak processionary moth) hair exposure — itchy rash, and rarely eye/throat irritation or breathing problems** — Animal Bites and Insects (`pu0feSX4qh8`)

**heart attack — a blocked artery stopping blood reaching the heart muscle, person usually conscious, breathing, and talking** — Heart Attack vs Cardiac Arrest: The Difference Could Save a Life (`daEErJU36-4`)

**heat exhaustion (body temperature at or above 38°c, hot, sweaty, distressed)** — Heat Exhaustion and Heat Stroke|  Adult First Aid  | EMT First Aid Training | (`Mzf-sslc2Zo`)
...
**someone struggling or drowning in open water** — Reach, Throw, Don't Go — what to do if someone's struggling in water (`MH5zM1q0RlU`)

**suspected concussion following a direct or transmitted-force blow to the head or body** — How to help Concussion in Sport |  Adult First Aid  | EMT First Aid Training | (`ohKowP1Posc`)

**swallowed poison (household chemicals, drugs — legal or illegal)** — Poisoning |  Adult First Aid  | EMT First Aid Training | (`w5eqBMoTGcE`)
